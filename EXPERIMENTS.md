...
- Launch: E142 was launched on 2026-05-16 from `/workspace/SimplexFold_e142`
  ...
  Latest heartbeat at `2026-05-16T21:53:30Z` showed `completed_step=8686`,
  active step `8687`, phase `microbatch_done`, active microbatch `1 / 8`,
  finite last train loss `4.690335512161255`, GPU utilization sampled at
  `93%`, GPU memory allocated at `43101 / 81920` MiB, and no
