...
`2026-05-18T06:20Z` reached `completed_step=9000`, active step `9000`,
`phase=evaluating`, and active eval batch `203 / 1000`. The run still reported
...
elapsed time `02:42:12`, process CPU time `1-10:31:01`, and `194` threads. The
artifact directory still had only inherited history, run metadata, and status;
`results.json`, `results.csv`, `eval_details_full_msa_to_face.csv`, and
