...
`2026-05-18T08:44Z` reached `completed_step=9000`, active step `9000`,
`phase=evaluating`, and active eval batch `902 / 1000`. The run still reported
...
were absent. A later live check at `2026-05-18T09:37Z` reached
`completed_step=8603`, active step `8604`, active microbatch `1 / 8`, finite
last train loss `4.7239959836006165`, and PID `414053` alive with elapsed time
`00:25:26`, process CPU time `03:46:04`, and `194` threads. The artifact
directory still had only inherited history, run metadata, and status;
`results.json`, `results.csv`, `eval_details_full_msa_to_face.csv`, and
`checkpoints/full_msa_to_face_latest.pt` were absent. A later live check at
`2026-05-18T09:49Z` reached `completed_step=8653`, active step `8654`, active
microbatch `1 / 8`, finite last train loss `4.414341956377029`, and PID
`414053` alive with elapsed time `00:36:59`, process CPU time `05:31:18`, and
`194` threads. The artifact directory still had only inherited history, run
metadata, and status; `results.json`, `results.csv`,
`eval_details_full_msa_to_face.csv`, and `checkpoints/full_msa_to_face_latest.pt`
were absent. A later live check at `2026-05-18T10:00Z` reached
`completed_step=8703`, active step `8704`, active microbatch `1 / 8`, finite
last train loss `4.118043065071106`, and PID `414053` alive with elapsed time
`00:48:47`, process CPU time `07:19:31`, and `194` threads. The artifact
directory still had only inherited history, run metadata, and status;
`results.json`, `results.csv`, `eval_details_full_msa_to_face.csv`, and
`checkpoints/full_msa_to_face_latest.pt` were absent. A later live check at
`2026-05-18T10:12Z` reached `completed_step=8751`, active step `8752`, active
microbatch `1 / 8`, finite last train loss `4.752621054649353`, and PID
`414053` alive with elapsed time `01:00:27`, process CPU time `09:07:10`, and
`194` threads. The artifact directory still had only inherited history, run
metadata, and status; `results.json`, `results.csv`,
`eval_details_full_msa_to_face.csv`, and `checkpoints/full_msa_to_face_latest.pt`
were absent. A later live check at `2026-05-18T10:24Z` reached
`completed_step=8801`, active step `8802`, active microbatch `1 / 8`, finite
last train loss `4.362206429243088`, and PID `414053` alive with elapsed time
`01:12:09`, process CPU time `10:52:05`, and `194` threads. The artifact
directory still had only inherited history, run metadata, and status;
`results.json`, `results.csv`, `eval_details_full_msa_to_face.csv`, and
`checkpoints/full_msa_to_face_latest.pt` were absent. A later live check at
`2026-05-18T10:36Z` reached `completed_step=8853`, active step `8854`, active
microbatch `1 / 8`, finite last train loss `4.603963732719421`, and PID
`414053` alive with elapsed time `01:24:48`, process CPU time `12:43:20`, and
`194` threads. The artifact directory still had only inherited history, run
metadata, and status; `results.json`, `results.csv`,
`eval_details_full_msa_to_face.csv`, and `checkpoints/full_msa_to_face_latest.pt`
were absent. A later live check at `2026-05-18T10:48Z` reached
`completed_step=8900`, active step `8901`, active microbatch `1 / 8`, finite
last train loss `4.5046254098415375`, and PID `414053` alive with elapsed time
`01:36:10`, process CPU time `14:24:54`, and `194` threads. The artifact
directory still had only inherited history, run metadata, and status;
`results.json`, `results.csv`, `eval_details_full_msa_to_face.csv`, and
`checkpoints/full_msa_to_face_latest.pt` were absent. A later live check at
`2026-05-18T11:01Z` reached `completed_step=8954`, active step `8955`, active
microbatch `1 / 8`, finite last train loss `4.188934475183487`, and PID
`414053` alive with elapsed time `01:49:19`, process CPU time `16:24:09`, and
`194` threads. The artifact directory still had only inherited history, run
metadata, and status; `results.json`, `results.csv`,
`eval_details_full_msa_to_face.csv`, and `checkpoints/full_msa_to_face_latest.pt`
...
and PID `414053` alive with elapsed time `03:42:54`, process CPU time
`2-10:27:40`, and `194` threads. Run metadata, status, and the inherited
history were still present, but `results.json`, `results.csv`,
`eval_details_full_msa_to_face.csv`, and `checkpoints/full_msa_to_face_latest.pt`
were absent. A later check at `2026-05-18T13:28Z` still showed
`completed_step=9000`, `phase=evaluating`, and PID `414053` alive with elapsed
time `04:16:25`, process CPU time `2-23:41:05`, and `194` threads. The log
...
`eval_details_full_msa_to_face.csv`, and `checkpoints/full_msa_to_face_latest.pt`
were absent. A later check at `2026-05-18T14:38Z` still showed
`completed_step=9000`, `phase=evaluating`, and PID `414053` alive with elapsed
...
were still absent. The latest live check reached `completed_step=8562`, active
step `8563`, active microbatch `1 / 8`, finite last train loss
`4.678828120231628`, and PID `496753` alive with elapsed time `15:02` and
process CPU time `02:15:34`; scored artifacts remain absent. The newest live
check reached `completed_step=8570`, active step `8571`, active microbatch
`1 / 8`, finite last train loss `4.532555401325226`, and PID `496753` alive
with elapsed time `17:01` and process CPU time `02:33:42`; scored artifacts
remain absent. The most recent live check reached `completed_step=8578`,
active step `8579`, active microbatch `1 / 8`, finite last train loss
`4.718557119369507`, and PID `496753` alive with elapsed time `18:51` and
process CPU time `02:50:06`; scored artifacts remain absent. Keep E150 running
