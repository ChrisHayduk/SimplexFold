...
- Launch: E142 was launched on 2026-05-16 from `/workspace/SimplexFold_e142`
  ...
  Latest heartbeat at `2026-05-16T22:10:28Z` showed `completed_step=8755`,
  active step `8756`, phase `microbatch_done`, active microbatch `1 / 8`,
  finite last train loss `4.567559540271759`, GPU utilization sampled at
  `39%`, GPU memory allocated at `43101 / 81920` MiB, and no
