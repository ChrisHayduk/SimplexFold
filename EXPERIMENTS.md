...
`2026-05-18T08:03Z` reached `completed_step=9000`, active step `9000`,
`phase=evaluating`, and active eval batch `702 / 1000`. The run still reported
...
elapsed time `04:26:09`, process CPU time `3-03:30:33`, and `194` threads. The
artifact directory still had only inherited history, run metadata, and status;
`results.json`, `results.csv`, `eval_details_full_msa_to_face.csv`, and
