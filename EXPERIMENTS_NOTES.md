...
- 2026-05-17T20:57Z E144 continued the final validation sweep on owned pod
  ...
  `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or documented
  terminal no-score state exists.
- 2026-05-17T21:16Z E144 continued the final validation sweep on owned pod
  `723hbew2jrvxjx`. Status showed completed step `9000`, active step `9000`,
  phase `evaluating`, active eval batch `800 / 1000`, effective batch size
  `8`, `num_workers=0`, `stopped_early=false`, finite last train loss
  `4.741060197353363`, and a fresh status mtime at `2026-05-17T21:16:13Z`.
  Trainer PID `172579` remained alive with elapsed time `04:50:27`, process
  CPU time `3-11:17:00`, and active running state. The artifact directory
  still had history, run metadata, and status only; no `results.json`, result
  CSV, eval-detail CSV, or checkpoint existed. Keep E144 running and keep
  `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or documented
  terminal no-score state exists.
- 2026-05-17T21:37Z E144 continued the final validation sweep on owned pod
  `723hbew2jrvxjx`. Status showed completed step `9000`, active step `9000`,
  phase `evaluating`, active eval batch `903 / 1000`, effective batch size
  `8`, `num_workers=0`, `stopped_early=false`, finite last train loss
  `4.741060197353363`, and a fresh status mtime at `2026-05-17T21:37:08Z`.
  Trainer PID `172579` remained alive with elapsed time `05:11:20`, process
  CPU time `3-19:27:03`, and active running state. The artifact directory
  still had history, run metadata, and status only; no `results.json`, result
  CSV, eval-detail CSV, or checkpoint existed. Keep E144 running and keep
  `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or documented
  terminal no-score state exists.
...
- 2026-05-17T22:39Z E147 continued coherent training. Status advanced to
  ...
  The artifact directory still had only history, run metadata, and status;
  no result bundle, eval-detail CSV, or checkpoint existed yet.
- 2026-05-17T22:41Z E147 continued coherent training. Status advanced to
  `completed_step=8632`, active step `8633`, active microbatch `1 / 8`, phase
  `microbatch_done`, fresh status mtime `2026-05-17T22:40:34Z`, and finite
  last train loss `4.628667175769806`. Trainer PID `253572` remained alive
  with elapsed time `32:09`, process CPU time `04:45:20`, and `194` threads.
  The artifact directory still had only history, run metadata, and status;
  no result bundle, eval-detail CSV, or checkpoint existed yet.
- 2026-05-17T22:43Z E147 continued coherent training. Status advanced to
  `completed_step=8642`, active step `8643`, active microbatch `1 / 8`, phase
  `microbatch_done`, fresh status mtime `2026-05-17T22:42:37Z`, and finite
  last train loss `4.6169679164886475`. Trainer PID `253572` remained alive
...
- 2026-05-17T22:50Z E147 continued coherent training. Status advanced to
  `completed_step=8677`, active step `8678`, active microbatch `1 / 8`, phase
  `microbatch_done`, `effective_batch_size=8`, `num_workers=0`,
  `stopped_early=false`, and finite last train loss `4.31253582239151`.
  Trainer PID `253572` remained alive with elapsed time `42:00`, process CPU
  time `06:13:20`, and `194` threads. The artifact directory still had only
  history, run metadata, and status; `results.json`, `results.csv`,
  `eval_details_full_msa_to_face.csv`, and
  `checkpoints/full_msa_to_face_latest.pt` were absent. Keep E147 running and
  leave `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or explicit
  terminal no-score outcome exists.
- 2026-05-17T22:52Z E147 continued coherent training. Status advanced to
  `completed_step=8686`, active step `8687`, active microbatch `1 / 8`, phase
  `microbatch_done`, `effective_batch_size=8`, `num_workers=0`,
  `stopped_early=false`, and finite last train loss `4.670756697654724`.
  Trainer PID `253572` remained alive with elapsed time `44:12`, process CPU
  time `06:34:02`, and `194` threads. The artifact directory still had only
  history, run metadata, and status; `results.json`, `results.csv`,
  `eval_details_full_msa_to_face.csv`, and
  `checkpoints/full_msa_to_face_latest.pt` were absent. Keep E147 running and
  leave `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or explicit
  terminal no-score outcome exists.
- 2026-05-17T22:54Z E147 continued coherent training. Status advanced to
  `completed_step=8695`, active step `8696`, active microbatch `1 / 8`, phase
  `microbatch_done`, `effective_batch_size=8`, `num_workers=0`,
  `stopped_early=false`, and finite last train loss `4.73601496219635`.
  Trainer PID `253572` remained alive with elapsed time `46:11`, process CPU
  time `06:51:11`, and `194` threads. The artifact directory still had only
  history, run metadata, and status; `results.json`, `results.csv`,
  `eval_details_full_msa_to_face.csv`, and
  `checkpoints/full_msa_to_face_latest.pt` were absent. Keep E147 running and
  leave `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or explicit
  terminal no-score outcome exists.
- 2026-05-17T22:56Z E147 continued coherent training. Status advanced to
  `completed_step=8703`, active step `8704`, active microbatch `1 / 8`, phase
  `microbatch_done`, `effective_batch_size=8`, `num_workers=0`,
  `stopped_early=false`, and finite last train loss `4.112482935190201`.
  Trainer PID `253572` remained alive with elapsed time `48:04`, process CPU
  time `07:08:24`, and `194` threads. The artifact directory still had only
  history, run metadata, and status; `results.json`, `results.csv`,
  `eval_details_full_msa_to_face.csv`, and
  `checkpoints/full_msa_to_face_latest.pt` were absent. Keep E147 running and
  leave `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or explicit
  terminal no-score outcome exists.
- 2026-05-17T22:58Z E147 continued coherent training. Status advanced to
  `completed_step=8710`, active step `8711`, active microbatch `1 / 8`, phase
  `microbatch_done`, `effective_batch_size=8`, `num_workers=0`,
  `stopped_early=false`, and finite last train loss `4.425106585025787`.
  Trainer PID `253572` remained alive with elapsed time `49:45`, process CPU
  time `07:23:51`, and `194` threads. The artifact directory still had only
  history, run metadata, and status; `results.json`, `results.csv`,
  `eval_details_full_msa_to_face.csv`, and
  `checkpoints/full_msa_to_face_latest.pt` were absent. Keep E147 running and
  leave `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or explicit
  terminal no-score outcome exists.
- 2026-05-17T23:00Z E147 continued coherent training. Status advanced to
  `completed_step=8718`, active step `8719`, active microbatch `1 / 8`, phase
  `microbatch_done`, `effective_batch_size=8`, `num_workers=0`,
  `stopped_early=false`, and finite last train loss `4.632701933383942`.
  Trainer PID `253572` remained alive with elapsed time `51:34`, process CPU
  time `07:40:40`, and `194` threads. The artifact directory still had only
  history, run metadata, and status; `results.json`, `results.csv`,
  `eval_details_full_msa_to_face.csv`, and
  `checkpoints/full_msa_to_face_latest.pt` were absent. Keep E147 running and
  leave `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or explicit
  terminal no-score outcome exists.
- 2026-05-17T23:02Z E147 continued coherent training. Status advanced to
  `completed_step=8727`, active step `8728`, active microbatch `1 / 8`, phase
  `microbatch_done`, `effective_batch_size=8`, `num_workers=0`,
  `stopped_early=false`, and finite last train loss `4.586958438158035`.
  Trainer PID `253572` remained alive with elapsed time `53:42`, process CPU
  time `07:59:42`, and `194` threads. The artifact directory still had only
  history, run metadata, and status; `results.json`, `results.csv`,
  `eval_details_full_msa_to_face.csv`, and
  `checkpoints/full_msa_to_face_latest.pt` were absent. Keep E147 running and
  leave `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or explicit
  terminal no-score outcome exists.
- 2026-05-17T23:04Z E147 continued coherent training. Status advanced to
  `completed_step=8737`, active step `8738`, active microbatch `1 / 8`, phase
  `microbatch_done`, `effective_batch_size=8`, `num_workers=0`,
  `stopped_early=false`, and finite last train loss `4.299148738384247`.
  Trainer PID `253572` remained alive with elapsed time `56:14`, process CPU
  time `08:21:14`, and `194` threads. The artifact directory still had only
  history, run metadata, and status; `results.json`, `results.csv`,
  `eval_details_full_msa_to_face.csv`, and
  `checkpoints/full_msa_to_face_latest.pt` were absent. Keep E147 running and
  leave `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or explicit
  terminal no-score outcome exists.
- 2026-05-17T23:06Z E147 continued coherent training. Status advanced to
  `completed_step=8746`, active step `8747`, active microbatch `1 / 8`, phase
  `microbatch_done`, `effective_batch_size=8`, `num_workers=0`,
  `stopped_early=false`, and finite last train loss `4.807082116603851`.
  Trainer PID `253572` remained alive with elapsed time `58:25`, process CPU
  time `08:42:27`, and `194` threads. The artifact directory still had only
  history, run metadata, and status; `results.json`, `results.csv`,
  `eval_details_full_msa_to_face.csv`, and
  `checkpoints/full_msa_to_face_latest.pt` were absent. Keep E147 running and
  leave `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or explicit
  terminal no-score outcome exists.
- 2026-05-17T23:09Z E147 continued coherent training. Status advanced to
  `completed_step=8756`, active step `8757`, active microbatch `1 / 8`, phase
  `microbatch_done`, `effective_batch_size=8`, `num_workers=0`,
  `stopped_early=false`, and finite last train loss `4.7651854157447815`.
  Trainer PID `253572` remained alive with elapsed time `01:00:41`, process
  CPU time `09:02:36`, and `194` threads. The artifact directory still had
  only history, run metadata, and status; `results.json`, `results.csv`,
  `eval_details_full_msa_to_face.csv`, and
  `checkpoints/full_msa_to_face_latest.pt` were absent. Keep E147 running and
  leave `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or explicit
  terminal no-score outcome exists.
- 2026-05-17T23:13Z E147 continued coherent training. Status advanced to
  `completed_step=8774`, active step `8775`, active microbatch `1 / 8`, phase
  `microbatch_done`, `effective_batch_size=8`, `num_workers=0`,
  `stopped_early=false`, and finite last train loss `4.732333779335022`.
  Trainer PID `253572` remained alive with elapsed time `01:04:50`, process
  CPU time `09:40:58`, and `194` threads. The artifact directory still had
  only history, run metadata, and status; `results.json`, `results.csv`,
  `eval_details_full_msa_to_face.csv`, and
  `checkpoints/full_msa_to_face_latest.pt` were absent. Keep E147 running and
  leave `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or explicit
  terminal no-score outcome exists.
- 2026-05-17T23:21Z E147 continued coherent training. Status advanced to
  `completed_step=8809`, active step `8810`, active microbatch `1 / 8`, phase
  `microbatch_done`, `effective_batch_size=8`, `num_workers=0`,
  `stopped_early=false`, and finite last train loss `4.48181289434433`.
  Trainer PID `253572` remained alive with elapsed time `01:12:56`, process
  CPU time `10:51:05`, and `194` threads. The artifact directory still had
  only history, run metadata, and status; `results.json`, `results.csv`,
  `eval_details_full_msa_to_face.csv`, and
  `checkpoints/full_msa_to_face_latest.pt` were absent. Keep E147 running and
  leave `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or explicit
  terminal no-score outcome exists.
- 2026-05-17T23:35Z E147 continued coherent training. Status advanced to
  `completed_step=8866`, active step `8867`, active microbatch `1 / 8`, phase
  `microbatch_done`, `effective_batch_size=8`, `num_workers=0`,
  `stopped_early=false`, and finite last train loss `4.613641649484634`.
  Trainer PID `253572` remained alive with elapsed time `01:26:38`, process
  CPU time `12:52:01`, and `194` threads. The artifact directory still had
  only history, run metadata, and status; `results.json`, `results.csv`,
  `eval_details_full_msa_to_face.csv`, and
  `checkpoints/full_msa_to_face_latest.pt` were absent. Keep E147 running and
  leave `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or explicit
  terminal no-score outcome exists.
- 2026-05-17T23:48Z E147 continued coherent training. Status advanced to
  `completed_step=8923`, active step `8924`, active microbatch `1 / 8`, phase
  `microbatch_done`, `effective_batch_size=8`, `num_workers=0`,
  `stopped_early=false`, and finite last train loss `4.176820605993271`.
  Trainer PID `253572` remained alive with elapsed time `01:40:07`, process
  CPU time `14:51:09`, and `194` threads. The artifact directory still had
  only history, run metadata, and status; `results.json`, `results.csv`,
  `eval_details_full_msa_to_face.csv`, and
  `checkpoints/full_msa_to_face_latest.pt` were absent. Keep E147 running and
  leave `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or explicit
  terminal no-score outcome exists.
- 2026-05-18T00:07Z E147 reached the final evaluation phase. Status reported
  `completed_step=9000`, active step `9000`, phase `evaluating`,
  `effective_batch_size=8`, `num_workers=0`, `stopped_early=false`, and finite
  last train loss `4.717868626117706`. Trainer PID `253572` remained alive
  with elapsed time `01:58:47`, process CPU time `17:39:09`, and `194`
  threads. The artifact directory still had only history, run metadata, and
  status; `results.json`, `results.csv`, `eval_details_full_msa_to_face.csv`,
  and `checkpoints/full_msa_to_face_latest.pt` were absent. Keep E147 running
  and leave `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or
  explicit terminal no-score outcome exists.
- 2026-05-18T00:25Z E147 continued final evaluation. Status reported
  `completed_step=9000`, active step `9000`, phase `evaluating`, active eval
  batch `87 / 1000`, `effective_batch_size=8`, `num_workers=0`,
  `stopped_early=false`, and finite last train loss `4.717868626117706`.
  Trainer PID `253572` remained alive with elapsed time `02:17:05`, process
  CPU time `1-00:50:50`, and `194` threads. The artifact directory still had
  only history, run metadata, and status; `results.json`, `results.csv`,
  `eval_details_full_msa_to_face.csv`, and
  `checkpoints/full_msa_to_face_latest.pt` were absent. Keep E147 running and
  leave `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or explicit
  terminal no-score outcome exists.
- 2026-05-18T00:43Z E147 continued final evaluation. Status reported
  `completed_step=9000`, active step `9000`, phase `evaluating`, active eval
  batch `178 / 1000`, `effective_batch_size=8`, `num_workers=0`,
  `stopped_early=false`, and finite last train loss `4.717868626117706`.
  Trainer PID `253572` remained alive with elapsed time `02:35:13`, process
  CPU time `1-07:58:27`, and `194` threads. The artifact directory still had
  only history, run metadata, and status; `results.json`, `results.csv`,
  `eval_details_full_msa_to_face.csv`, and
  `checkpoints/full_msa_to_face_latest.pt` were absent. Keep E147 running and
  leave `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or explicit
  terminal no-score outcome exists.
- 2026-05-18T01:18Z E147 continued final evaluation. Status reported
  `completed_step=9000`, active step `9000`, phase `evaluating`, active eval
  batch `351 / 1000`, `effective_batch_size=8`, `num_workers=0`,
  `stopped_early=false`, and finite last train loss `4.717868626117706`.
  Trainer PID `253572` remained alive with elapsed time `03:10:22`, process
  CPU time `1-21:47:16`, and `194` threads. The artifact directory still had
  only history, run metadata, and status; `results.json`, `results.csv`,
  `eval_details_full_msa_to_face.csv`, and
  `checkpoints/full_msa_to_face_latest.pt` were absent. Keep E147 running and
  leave `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or explicit
  terminal no-score outcome exists.
- 2026-05-18T01:43Z E147 continued final evaluation. Status reported
  `completed_step=9000`, active step `9000`, phase `evaluating`, active eval
  batch `458 / 1000`, `effective_batch_size=8`, `num_workers=0`,
  `stopped_early=false`, and finite last train loss `4.717868626117706`.
  Trainer PID `253572` remained alive with elapsed time `03:34:48`, process
  CPU time `2-07:27:34`, and `194` threads. The artifact directory still had
  only history, run metadata, and status; `results.json`, `results.csv`,
  `eval_details_full_msa_to_face.csv`, and
  `checkpoints/full_msa_to_face_latest.pt` were absent. Keep E147 running and
  leave `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or explicit
  terminal no-score outcome exists.
- 2026-05-18T02:03Z E147 continued final evaluation. Status reported
  `completed_step=9000`, active step `9000`, phase `evaluating`, active eval
  batch `557 / 1000`, `effective_batch_size=8`, `num_workers=0`,
  `stopped_early=false`, and finite last train loss `4.717868626117706`.
  Trainer PID `253572` remained alive with elapsed time `03:55:14`, process
  CPU time `2-15:33:39`, and `194` threads. The artifact directory still had
  only history, run metadata, and status; `results.json`, `results.csv`,
  `eval_details_full_msa_to_face.csv`, and
  `checkpoints/full_msa_to_face_latest.pt` were absent. Keep E147 running and
  leave `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or explicit
  terminal no-score outcome exists.
- 2026-05-18T02:23Z E147 continued final evaluation. Status reported
  `completed_step=9000`, active step `9000`, phase `evaluating`, active eval
  batch `653 / 1000`, `effective_batch_size=8`, `num_workers=0`,
  `stopped_early=false`, and finite last train loss `4.717868626117706`.
  Trainer PID `253572` remained alive with elapsed time `04:14:30`, process
  CPU time `2-23:03:45`, and `194` threads. The artifact directory still had
  only history, run metadata, and status; `results.json`, `results.csv`,
  `eval_details_full_msa_to_face.csv`, and
  `checkpoints/full_msa_to_face_latest.pt` were absent. Keep E147 running and
  leave `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or explicit
  terminal no-score outcome exists.
- 2026-05-18T02:43Z E147 continued final evaluation. Status reported
  `completed_step=9000`, active step `9000`, phase `evaluating`, active eval
  batch `753 / 1000`, `effective_batch_size=8`, `num_workers=0`,
  `stopped_early=false`, and finite last train loss `4.717868626117706`.
  Trainer PID `253572` remained alive with elapsed time `04:34:58`, process
  CPU time `3-07:05:06`, and `194` threads. The artifact directory still had
  only history, run metadata, and status; `results.json`, `results.csv`,
  `eval_details_full_msa_to_face.csv`, and
  `checkpoints/full_msa_to_face_latest.pt` were absent. Keep E147 running and
  leave `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or explicit
  terminal no-score outcome exists.
- 2026-05-18T03:02Z E147 continued final evaluation. Status reported
  `completed_step=9000`, active step `9000`, phase `evaluating`, active eval
  batch `850 / 1000`, `effective_batch_size=8`, `num_workers=0`,
  `stopped_early=false`, and finite last train loss `4.717868626117706`.
  Trainer PID `253572` remained alive with elapsed time `04:53:41`, process
  CPU time `3-14:25:33`, and `194` threads. The artifact directory still had
  only history, run metadata, and status; `results.json`, `results.csv`,
  `eval_details_full_msa_to_face.csv`, and
  `checkpoints/full_msa_to_face_latest.pt` were absent. Keep E147 running and
  leave `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or explicit
...
- 2026-05-18T03:37Z Launched E148 degree-normalized selected-boundary
  ...
  leave `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or explicit
  terminal no-score outcome exists.
- 2026-05-18T03:52Z E148 continued coherent training. Status reported
  `completed_step=8559`, active step `8560`, active microbatch `1 / 8`,
  `effective_batch_size=8`, `num_workers=0`, `stopped_early=false`, and
  finite last train loss `4.291964113712311`. Trainer PID `331052` remained
  alive with elapsed time `14:30`, process CPU time `02:07:37`, and `194`
  threads. The artifact directory still had only history, run metadata, and
  status; `results.json`, `results.csv`, `eval_details_full_msa_to_face.csv`,
  and `checkpoints/full_msa_to_face_latest.pt` were absent. Keep E148 running
  and leave `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or
  explicit terminal no-score outcome exists.
- 2026-05-18T04:02Z E148 continued coherent training. Status reported
  `completed_step=8601`, active step `8602`, active microbatch `1 / 8`,
  `effective_batch_size=8`, `num_workers=0`, `stopped_early=false`, and
  finite last train loss `4.495228797197342`. Trainer PID `331052` remained
  alive with elapsed time `24:55`, process CPU time `03:40:59`, and `194`
  threads. The artifact directory still had only history, run metadata, and
  status; `results.json`, `results.csv`, `eval_details_full_msa_to_face.csv`,
  and `checkpoints/full_msa_to_face_latest.pt` were absent. Keep E148 running
  and leave `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or
...
- 2026-05-18T04:14Z E148 continued coherent training. Status reported
  ...
  and leave `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or
  explicit terminal no-score outcome exists.
- 2026-05-18T04:26Z E148 continued coherent training. Status reported
  `completed_step=8701`, active step `8702`, active microbatch `1 / 8`,
  `effective_batch_size=8`, `num_workers=0`, `stopped_early=false`, and
  finite last train loss `4.931789696216583`. Trainer PID `331052` remained
  alive with elapsed time `48:39`, process CPU time `07:19:14`, and `194`
  threads. The artifact directory still had only history, run metadata, and
  status; `results.json`, `results.csv`, `eval_details_full_msa_to_face.csv`,
  and `checkpoints/full_msa_to_face_latest.pt` were absent. Keep E148 running
  and leave `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or
  explicit terminal no-score outcome exists.
- 2026-05-18T04:38Z E148 continued coherent training. Status reported
  `completed_step=8752`, active step `8753`, active microbatch `1 / 8`,
  `effective_batch_size=8`, `num_workers=0`, `stopped_early=false`, and
  finite last train loss `4.762001156806946`. Trainer PID `331052` remained
  alive with elapsed time `01:01:00`, process CPU time `09:14:25`, and `194`
  threads. The artifact directory still had only history, run metadata, and
  status; `results.json`, `results.csv`, `eval_details_full_msa_to_face.csv`,
  and `checkpoints/full_msa_to_face_latest.pt` were absent. Keep E148 running
  and leave `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or
  explicit terminal no-score outcome exists.
- 2026-05-18T04:50Z E148 continued coherent training. Status reported
  `completed_step=8802`, active step `8803`, active microbatch `1 / 8`,
  `effective_batch_size=8`, `num_workers=0`, `stopped_early=false`, and
  finite last train loss `4.674457550048828`. Trainer PID `331052` remained
  alive with elapsed time `01:12:49`, process CPU time `11:01:20`, and `194`
  threads. The artifact directory still had only history, run metadata, and
  status; `results.json`, `results.csv`, `eval_details_full_msa_to_face.csv`,
  and `checkpoints/full_msa_to_face_latest.pt` were absent. Keep E148 running
  and leave `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or
  explicit terminal no-score outcome exists.
- 2026-05-18T05:02Z E148 continued coherent training. Status reported
  `completed_step=8851`, active step `8852`, active microbatch `1 / 8`,
  `effective_batch_size=8`, `num_workers=0`, `stopped_early=false`, and
  finite last train loss `4.694023817777634`. Trainer PID `331052` remained
  alive with elapsed time `01:24:32`, process CPU time `12:45:11`, and `194`
  threads. The artifact directory still had only history, run metadata, and
  status; `results.json`, `results.csv`, `eval_details_full_msa_to_face.csv`,
  and `checkpoints/full_msa_to_face_latest.pt` were absent. Keep E148 running
  and leave `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or
  explicit terminal no-score outcome exists.
- 2026-05-18T05:14Z E148 continued coherent training. Status reported
  `completed_step=8901`, active step `8902`, active microbatch `1 / 8`,
  `effective_batch_size=8`, `num_workers=0`, `stopped_early=false`, and
  finite last train loss `4.727553129196167`. Trainer PID `331052` remained
  alive with elapsed time `01:36:24`, process CPU time `14:29:18`, and `194`
  threads. The artifact directory still had only history, run metadata, and
  status; `results.json`, `results.csv`, `eval_details_full_msa_to_face.csv`,
  and `checkpoints/full_msa_to_face_latest.pt` were absent. Keep E148 running
  and leave `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or
  explicit terminal no-score outcome exists.
- 2026-05-18T05:26Z E148 continued coherent training. Status reported
  `completed_step=8952`, active step `8953`, active microbatch `1 / 8`,
  `effective_batch_size=8`, `num_workers=0`, `stopped_early=false`, and
  finite last train loss `4.513890564441681`. Trainer PID `331052` remained
  alive with elapsed time `01:48:29`, process CPU time `16:18:36`, and `194`
  threads. The artifact directory still had only history, run metadata, and
  status; `results.json`, `results.csv`, `eval_details_full_msa_to_face.csv`,
  and `checkpoints/full_msa_to_face_latest.pt` were absent. Keep E148 running
  and leave `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or
  explicit terminal no-score outcome exists.
- 2026-05-18T05:39Z E148 reached target step and entered final evaluation.
  Status reported `completed_step=9000`, active step `9000`,
  `phase=evaluating`, active eval batch `5 / 1000`, `effective_batch_size=8`,
  `num_workers=0`, `stopped_early=false`, and finite last train loss
  `4.766671359539032`. Trainer PID `331052` remained alive with elapsed time
  `02:00:39`, process CPU time `18:11:48`, and `194` threads. The artifact
  directory still had only history, run metadata, and status; `results.json`,
  ...
  leave `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or explicit
  terminal no-score outcome exists.
- 2026-05-18T05:59Z E148 continued final evaluation. Status reported
  `completed_step=9000`, active step `9000`, `phase=evaluating`, active eval
  batch `104 / 1000`, `effective_batch_size=8`, `num_workers=0`,
  `stopped_early=false`, and finite last train loss `4.766671359539032`.
  Trainer PID `331052` remained alive with elapsed time `02:21:51`, process
  CPU time `1-02:29:57`, and `194` threads. The artifact directory still had
  only history, run metadata, and status; `results.json`, `results.csv`,
  `eval_details_full_msa_to_face.csv`, and
  `checkpoints/full_msa_to_face_latest.pt` were absent. Keep E148 running and
  leave `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or explicit
  terminal no-score outcome exists.
- 2026-05-18T06:20Z E148 continued coherent final evaluation. Status reported
  `completed_step=9000`, active step `9000`, `phase=evaluating`, active eval
  batch `203 / 1000`, `effective_batch_size=8`, `num_workers=0`,
  `stopped_early=false`, and finite last train loss `4.766671359539032`.
  Trainer PID `331052` remained alive with elapsed time `02:42:12`, process
  CPU time `1-10:31:01`, and `194` threads. The artifact directory still had
  only history, run metadata, and status; `results.json`, `results.csv`,
  `eval_details_full_msa_to_face.csv`, and
  `checkpoints/full_msa_to_face_latest.pt` were absent. Keep E148 running and
  leave `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or explicit
  terminal no-score outcome exists.
- 2026-05-18T06:39Z E148 continued coherent final evaluation. Status reported
  `completed_step=9000`, active step `9000`, `phase=evaluating`, active eval
  batch `301 / 1000`, `effective_batch_size=8`, `num_workers=0`,
  `stopped_early=false`, and finite last train loss `4.766671359539032`.
  Trainer PID `331052` remained alive with elapsed time `03:02:00`, process
  CPU time `1-18:17:35`, and `194` threads. The artifact directory still had
  only history, run metadata, and status; `results.json`, `results.csv`,
  `eval_details_full_msa_to_face.csv`, and
  `checkpoints/full_msa_to_face_latest.pt` were absent. Keep E148 running and
  leave `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or explicit
  terminal no-score outcome exists.
- 2026-05-18T07:01Z E148 continued coherent final evaluation. Status reported
  `completed_step=9000`, active step `9000`, `phase=evaluating`, active eval
  batch `404 / 1000`, `effective_batch_size=8`, `num_workers=0`,
  `stopped_early=false`, and finite last train loss `4.766671359539032`.
  Trainer PID `331052` remained alive with elapsed time `03:23:43`, process
  CPU time `2-02:52:30`, and `194` threads. The artifact directory still had
  only history, run metadata, and status; `results.json`, `results.csv`,
  `eval_details_full_msa_to_face.csv`, and
  `checkpoints/full_msa_to_face_latest.pt` were absent. Keep E148 running and
  leave `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or explicit
  terminal no-score outcome exists.
- 2026-05-18T07:22Z E148 crossed halfway through final evaluation. Status
  reported `completed_step=9000`, active step `9000`, `phase=evaluating`,
  active eval batch `501 / 1000`, `effective_batch_size=8`, `num_workers=0`,
  `stopped_early=false`, and finite last train loss `4.766671359539032`.
  Trainer PID `331052` remained alive with elapsed time `03:45:09`, process
  CPU time `2-11:21:09`, and `194` threads. The artifact directory still had
  only history, run metadata, and status; `results.json`, `results.csv`,
  `eval_details_full_msa_to_face.csv`, and
  `checkpoints/full_msa_to_face_latest.pt` were absent. Keep E148 running and
  leave `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or explicit
  terminal no-score outcome exists.
- 2026-05-18T07:44Z E148 continued coherent final evaluation. Status reported
  `completed_step=9000`, active step `9000`, `phase=evaluating`, active eval
  batch `605 / 1000`, `effective_batch_size=8`, `num_workers=0`,
  `stopped_early=false`, and finite last train loss `4.766671359539032`.
  Trainer PID `331052` remained alive with elapsed time `04:06:25`, process
  CPU time `2-19:45:27`, and `194` threads. The artifact directory still had
  only history, run metadata, and status; `results.json`, `results.csv`,
  `eval_details_full_msa_to_face.csv`, and
  `checkpoints/full_msa_to_face_latest.pt` were absent. Keep E148 running and
  leave `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or explicit
  terminal no-score outcome exists.
- 2026-05-18T08:03Z E148 continued coherent final evaluation. Status reported
  `completed_step=9000`, active step `9000`, `phase=evaluating`, active eval
  batch `702 / 1000`, `effective_batch_size=8`, `num_workers=0`,
  `stopped_early=false`, and finite last train loss `4.766671359539032`.
  Trainer PID `331052` remained alive with elapsed time `04:26:09`, process
  CPU time `3-03:30:33`, and `194` threads. The artifact directory still had
  only history, run metadata, and status; `results.json`, `results.csv`,
  `eval_details_full_msa_to_face.csv`, and
  `checkpoints/full_msa_to_face_latest.pt` were absent. Keep E148 running and
  leave `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or explicit
  terminal no-score outcome exists.
- 2026-05-18T08:25Z E148 continued coherent final evaluation. Status reported
  `completed_step=9000`, active step `9000`, `phase=evaluating`, active eval
  batch `805 / 1000`, `effective_batch_size=8`, `num_workers=0`,
  `stopped_early=false`, and finite last train loss `4.766671359539032`.
  Trainer PID `331052` remained alive with elapsed time `04:47:12`, process
  CPU time `3-11:46:04`, and `194` threads. The artifact directory still had
  only history, run metadata, and status; `results.json`, `results.csv`,
  `eval_details_full_msa_to_face.csv`, and
  `checkpoints/full_msa_to_face_latest.pt` were absent. Keep E148 running and
  leave `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or explicit
  terminal no-score outcome exists.
- 2026-05-18T08:44Z E148 continued coherent final evaluation. Status reported
  `completed_step=9000`, active step `9000`, `phase=evaluating`, active eval
  batch `902 / 1000`, `effective_batch_size=8`, `num_workers=0`,
  `stopped_early=false`, and finite last train loss `4.766671359539032`.
  Trainer PID `331052` remained alive with elapsed time `05:07:02`, process
  CPU time `3-19:31:50`, and `194` threads. The artifact directory still had
  only history, run metadata, and status; `results.json`, `results.csv`,
  `eval_details_full_msa_to_face.csv`, and
  `checkpoints/full_msa_to_face_latest.pt` were absent. Keep E148 running and
  leave `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or explicit
...
- 2026-05-18T09:24Z E149 continued coherent training. Status reported
  `completed_step=8552`, active step `8553`, active microbatch `1 / 8`,
  `effective_batch_size=8`, `num_workers=0`, `stopped_early=false`, and
  finite last train loss `4.269135743379593`. Trainer PID `414053` remained
  alive with elapsed time `00:12:49`, process CPU time `01:53:26`, and `194`
  threads. The artifact directory still had only inherited history, run
  metadata, and status; `results.json`, `results.csv`,
  `eval_details_full_msa_to_face.csv`, and
  `checkpoints/full_msa_to_face_latest.pt` were absent. Keep E149 running and
  leave `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or explicit
  terminal no-score outcome exists.
- 2026-05-18T09:37Z E149 continued coherent training. Status reported
  `completed_step=8603`, active step `8604`, active microbatch `1 / 8`,
  `effective_batch_size=8`, `num_workers=0`, `stopped_early=false`, and
  finite last train loss `4.7239959836006165`. Trainer PID `414053` remained
  alive with elapsed time `00:25:26`, process CPU time `03:46:04`, and `194`
  threads. The artifact directory still had only inherited history, run
  metadata, and status; `results.json`, `results.csv`,
  `eval_details_full_msa_to_face.csv`, and
  `checkpoints/full_msa_to_face_latest.pt` were absent. Keep E149 running and
  leave `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or explicit
  terminal no-score outcome exists.
- 2026-05-18T09:49Z E149 continued coherent training. Status reported
  `completed_step=8653`, active step `8654`, active microbatch `1 / 8`,
  `effective_batch_size=8`, `num_workers=0`, `stopped_early=false`, and
  finite last train loss `4.414341956377029`. Trainer PID `414053` remained
  alive with elapsed time `00:36:59`, process CPU time `05:31:18`, and `194`
  threads. The artifact directory still had only inherited history, run
  metadata, and status; `results.json`, `results.csv`,
  `eval_details_full_msa_to_face.csv`, and
  `checkpoints/full_msa_to_face_latest.pt` were absent. Keep E149 running and
  leave `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or explicit
  terminal no-score outcome exists.
- 2026-05-18T10:00Z E149 continued coherent training. Status reported
  `completed_step=8703`, active step `8704`, active microbatch `1 / 8`,
  `effective_batch_size=8`, `num_workers=0`, `stopped_early=false`, and
  finite last train loss `4.118043065071106`. Trainer PID `414053` remained
  alive with elapsed time `00:48:47`, process CPU time `07:19:31`, and `194`
  threads. The artifact directory still had only inherited history, run
  metadata, and status; `results.json`, `results.csv`,
  `eval_details_full_msa_to_face.csv`, and
  `checkpoints/full_msa_to_face_latest.pt` were absent. Keep E149 running and
  leave `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or explicit
  terminal no-score outcome exists.
- 2026-05-18T10:12Z E149 continued coherent training. Status reported
  `completed_step=8751`, active step `8752`, active microbatch `1 / 8`,
  `effective_batch_size=8`, `num_workers=0`, `stopped_early=false`, and
  finite last train loss `4.752621054649353`. Trainer PID `414053` remained
  alive with elapsed time `01:00:27`, process CPU time `09:07:10`, and `194`
  threads. The artifact directory still had only inherited history, run
  metadata, and status; `results.json`, `results.csv`,
  `eval_details_full_msa_to_face.csv`, and
  `checkpoints/full_msa_to_face_latest.pt` were absent. Keep E149 running and
  leave `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or explicit
  terminal no-score outcome exists.
- 2026-05-18T10:24Z E149 continued coherent training. Status reported
  `completed_step=8801`, active step `8802`, active microbatch `1 / 8`,
  `effective_batch_size=8`, `num_workers=0`, `stopped_early=false`, and
  finite last train loss `4.362206429243088`. Trainer PID `414053` remained
  alive with elapsed time `01:12:09`, process CPU time `10:52:05`, and `194`
  threads. The artifact directory still had only inherited history, run
  metadata, and status; `results.json`, `results.csv`,
  `eval_details_full_msa_to_face.csv`, and
  `checkpoints/full_msa_to_face_latest.pt` were absent. Keep E149 running and
  leave `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or explicit
  terminal no-score outcome exists.
- 2026-05-18T10:36Z E149 continued coherent training. Status reported
  `completed_step=8853`, active step `8854`, active microbatch `1 / 8`,
  `effective_batch_size=8`, `num_workers=0`, `stopped_early=false`, and
  finite last train loss `4.603963732719421`. Trainer PID `414053` remained
  alive with elapsed time `01:24:48`, process CPU time `12:43:20`, and `194`
  threads. The artifact directory still had only inherited history, run
  metadata, and status; `results.json`, `results.csv`,
  `eval_details_full_msa_to_face.csv`, and
  `checkpoints/full_msa_to_face_latest.pt` were absent. Keep E149 running and
  leave `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or explicit
  terminal no-score outcome exists.
- 2026-05-18T10:48Z E149 continued coherent training. Status reported
  `completed_step=8900`, active step `8901`, active microbatch `1 / 8`,
  `effective_batch_size=8`, `num_workers=0`, `stopped_early=false`, and
  finite last train loss `4.5046254098415375`. Trainer PID `414053` remained
  alive with elapsed time `01:36:10`, process CPU time `14:24:54`, and `194`
  threads. The artifact directory still had only inherited history, run
  metadata, and status; `results.json`, `results.csv`,
  `eval_details_full_msa_to_face.csv`, and
  `checkpoints/full_msa_to_face_latest.pt` were absent. Keep E149 running and
  leave `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or explicit
  terminal no-score outcome exists.
- 2026-05-18T11:01Z E149 continued coherent training. Status reported
  `completed_step=8954`, active step `8955`, active microbatch `1 / 8`,
  `effective_batch_size=8`, `num_workers=0`, `stopped_early=false`, and
  finite last train loss `4.188934475183487`. Trainer PID `414053` remained
  alive with elapsed time `01:49:19`, process CPU time `16:24:09`, and `194`
  threads. The artifact directory still had only inherited history, run
  metadata, and status; `results.json`, `results.csv`,
  `eval_details_full_msa_to_face.csv`, and
  `checkpoints/full_msa_to_face_latest.pt` were absent. Keep E149 running and
  leave `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or explicit
  terminal no-score outcome exists.
- 2026-05-18T11:36Z E149 reached the final validation phase but had not written
  a scored bundle yet. Status reported `completed_step=9000`,
  `phase=evaluating`, `effective_batch_size=8`, `num_workers=0`,
  `stopped_early=false`, and finite last train loss `4.7315435111522675`.
  Trainer PID `414053` remained alive with elapsed time `02:24:05`, process CPU
  time `1-03:19:15`, and `194` threads. Run metadata, status, and inherited
  history were present; `results.json`, `results.csv`,
  `eval_details_full_msa_to_face.csv`, and
...
- 2026-05-18T12:31Z E149 was still in active final validation. Status reported
  ...
  through final validation and leave `EXPERIMENT_RESULTS.md` unchanged until a
  scored bundle or explicit terminal no-score outcome exists.
- 2026-05-18T12:55Z E149 was still in active final validation. Status reported
  `completed_step=9000`, `phase=evaluating`, `effective_batch_size=8`,
  `num_workers=0`, `stopped_early=false`, and finite last train loss
  `4.7315435111522675`. Trainer PID `414053` remained alive with elapsed time
  `03:42:54`, process CPU time `2-10:27:40`, and `194` threads. Run metadata,
  status, and inherited history were present; `results.json`, `results.csv`,
  `eval_details_full_msa_to_face.csv`, and
  `checkpoints/full_msa_to_face_latest.pt` were absent. Keep E149 running
  through final validation and leave `EXPERIMENT_RESULTS.md` unchanged until a
  scored bundle or explicit terminal no-score outcome exists.
- 2026-05-18T13:28Z E149 was still in active final validation. Status reported
  `completed_step=9000`, `phase=evaluating`, `effective_batch_size=8`,
  `num_workers=0`, `stopped_early=false`, and finite last train loss
  `4.7315435111522675`. Trainer PID `414053` remained alive with elapsed time
  `04:16:25`, process CPU time `2-23:41:05`, and `194` threads. Run metadata,
  status, and inherited history were present; the log tail still only contained
  startup/resume lines; `results.json`, `results.csv`,
  `eval_details_full_msa_to_face.csv`, and
  `checkpoints/full_msa_to_face_latest.pt` were absent. Keep E149 running
  through final validation and leave `EXPERIMENT_RESULTS.md` unchanged until a
  scored bundle or explicit terminal no-score outcome exists.
- 2026-05-18T14:02Z E149 was still in active final validation. Status reported
  `completed_step=9000`, `phase=evaluating`, `effective_batch_size=8`,
  `num_workers=0`, `stopped_early=false`, and finite last train loss
  `4.7315435111522675`. Trainer PID `414053` remained alive with elapsed time
  `04:50:47`, process CPU time `3-13:10:37`, and `194` threads. Run metadata,
  status, and inherited history were present; `results.json`, `results.csv`,
  `eval_details_full_msa_to_face.csv`, and
  `checkpoints/full_msa_to_face_latest.pt` were absent. Keep E149 running
  through final validation and leave `EXPERIMENT_RESULTS.md` unchanged until a
  scored bundle or explicit terminal no-score outcome exists.
- 2026-05-18T14:38Z E149 was still in active final validation. Status reported
  `completed_step=9000`, `phase=evaluating`, `effective_batch_size=8`,
  `num_workers=0`, `stopped_early=false`, and finite last train loss
  `4.7315435111522675`. Trainer PID `414053` remained alive with elapsed time
  `05:26:11`, process CPU time `4-03:09:24`, and `194` threads. Run metadata,
  status, and inherited history were present; `results.json`, `results.csv`,
  `eval_details_full_msa_to_face.csv`, and
  `checkpoints/full_msa_to_face_latest.pt` were absent. Keep E149 running
  through final validation and leave `EXPERIMENT_RESULTS.md` unchanged until a
...
- E150 live sample: status reported `completed_step=8543`, active step
  ...
  leave `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or explicit
  terminal no-score outcome exists.
- E150 live sample: status reported `completed_step=8552`, active step
  ...
  leave `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or explicit
  terminal no-score outcome exists.
- E150 live sample: status reported `completed_step=8562`, active step
  `8563`, active microbatch `1 / 8`, `effective_batch_size=8`,
  `num_workers=0`, `stopped_early=false`, and finite last train loss
  `4.678828120231628`. Trainer PID `496753` remained alive with elapsed time
  `15:02` and process CPU time `02:15:34`. The artifact directory still had
  only inherited history, run metadata, and status; `results.json`,
  `results.csv`, `eval_details_full_msa_to_face.csv`, and
  `checkpoints/full_msa_to_face_latest.pt` were absent. Keep E150 running and
  leave `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or explicit
  terminal no-score outcome exists.
- E150 live sample: status reported `completed_step=8570`, active step
  `8571`, active microbatch `1 / 8`, `effective_batch_size=8`,
  `num_workers=0`, `stopped_early=false`, and finite last train loss
  `4.532555401325226`. Trainer PID `496753` remained alive with elapsed time
  `17:01` and process CPU time `02:33:42`. The artifact directory still had
  only inherited history, run metadata, and status; `results.json`,
  `results.csv`, `eval_details_full_msa_to_face.csv`, and
  `checkpoints/full_msa_to_face_latest.pt` were absent. Keep E150 running and
  leave `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or explicit
  terminal no-score outcome exists.
- E150 live sample: status reported `completed_step=8578`, active step
  `8579`, active microbatch `1 / 8`, `effective_batch_size=8`,
  `num_workers=0`, `stopped_early=false`, and finite last train loss
  `4.718557119369507`. Trainer PID `496753` remained alive with elapsed time
  `18:51` and process CPU time `02:50:06`. The artifact directory still had
  only inherited history, run metadata, and status; `results.json`,
  `results.csv`, `eval_details_full_msa_to_face.csv`, and
  `checkpoints/full_msa_to_face_latest.pt` were absent. Keep E150 running and
  leave `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or explicit
  terminal no-score outcome exists.
- E150 live sample: status reported `completed_step=8585`, active step
  `8586`, active microbatch `1 / 8`, `effective_batch_size=8`,
  `num_workers=0`, `stopped_early=false`, and finite last train loss
  `4.467027068138123`. Trainer PID `496753` remained alive with elapsed time
  `20:39` and process CPU time `03:06:25`. The artifact directory still had
  only inherited history, run metadata, and status; `results.json`,
  `results.csv`, `eval_details_full_msa_to_face.csv`, and
  `checkpoints/full_msa_to_face_latest.pt` were absent. Keep E150 running and
  leave `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or explicit
  terminal no-score outcome exists.
- Latest E150 live sample: status reported `completed_step=8594`, active step
  `8595`, active microbatch `1 / 8`, `effective_batch_size=8`,
  `num_workers=0`, `stopped_early=false`, and finite last train loss
  `4.8075379729270935`. Trainer PID `496753` remained alive with elapsed time
  `22:46` and process CPU time `03:24:36`. The artifact directory still had
  only inherited history, run metadata, and status; `results.json`,
  `results.csv`, `eval_details_full_msa_to_face.csv`, and
  `checkpoints/full_msa_to_face_latest.pt` were absent. Keep E150 running and
  leave `EXPERIMENT_RESULTS.md` unchanged until a scored bundle or explicit
