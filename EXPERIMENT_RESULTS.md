...
| E130 Hodge-centered boundary readout | runtime failed | - | - | - | - | - | - | Stopped after roughly 3 hours with no step-9000 history, result bundle, eval details, or checkpoint; history remained at inherited E128 step 8500. Treat static Hodge double-centering as a runtime-failed branch and use the no-Hodge E138 fallback instead. |
