...
Latest heartbeat at `2026-05-16T21:35:43Z` showed coherent progress at
`completed_step=8614`, active step `8615`, phase `microbatch_done`, active
microbatch `1 / 8`, effective batch size `8`, `num_workers=0`, finite last
train loss `4.385830670595169`, live trainer PID `13262`, GPU utilization
sampled at `30%`, and GPU memory allocated at `43101 / 81920` MiB. The
