...
Latest heartbeat at `2026-05-16T19:59Z` showed coherent progress at
`completed_step=8835`, active step `8836`, active microbatch `1 / 8`,
effective batch size `8`, `num_workers=4`, finite last train loss
`4.422989010810852`, live trainer PID `6336`, and GPU utilization sampled at
`69%` with `23191 / 81920` MiB allocated. The artifact directory still has no
