...
Latest heartbeat at `2026-05-16T22:32:55Z` showed coherent progress at
`completed_step=8849`, active step `8850`, phase `microbatch_done`, active
microbatch `1 / 8`, effective batch size `8`, `num_workers=0`, finite last
train loss `4.840060532093048`, live trainer PID `13262`, GPU utilization
sampled at `14%` with GPU memory allocated at `43101 / 81920` MiB. The
