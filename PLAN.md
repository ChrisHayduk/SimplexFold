...
Latest heartbeat at `2026-05-16T22:48:07Z` showed coherent progress at
`completed_step=8911`, active step `8912`, phase `microbatch_done`, active
microbatch `1 / 8`, effective batch size `8`, `num_workers=0`, finite last
train loss `4.870556473731995`, live trainer PID `13262`, GPU utilization
sampled at `19%` with GPU memory allocated at `43101 / 81920` MiB. The
