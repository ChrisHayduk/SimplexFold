...
Latest heartbeat at `2026-05-16T22:07:59Z` showed coherent progress at
`completed_step=8746`, active step `8747`, phase
`microbatch_forward_start`, active microbatch `1 / 8`, effective batch size
`8`, `num_workers=0`, finite last train loss `4.792213648557663`, live
trainer PID `13262`, GPU utilization sampled at `43%`, and GPU memory
