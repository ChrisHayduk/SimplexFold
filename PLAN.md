...
latest live check at `2026-05-18T06:39Z` reached `completed_step=9000`,
entered `phase=evaluating`, and reached active eval batch `301 / 1000`. The
...
`331052` alive with elapsed time `03:02:00`, process CPU time `1-18:17:35`,
