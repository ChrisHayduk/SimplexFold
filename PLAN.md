...
Latest heartbeat at `2026-05-16T20:07Z` showed coherent progress at
`completed_step=8874`, active step `8875`, active microbatch `1 / 8`,
effective batch size `8`, `num_workers=4`, finite last train loss
`4.15495491027832`, live trainer PID `6336`, and GPU utilization sampled at
`66%` with `23191 / 81920` MiB allocated. The artifact directory still has no
