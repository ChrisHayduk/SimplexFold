...
Latest heartbeat at `2026-05-16T22:16:51Z` showed coherent progress at
`completed_step=8781`, active step `8782`, phase `microbatch_done`, active
microbatch `1 / 8`, effective batch size `8`, `num_workers=0`, finite last
train loss `4.519021540880203`, live trainer PID `13262`, GPU utilization
sampled at `67%`, and GPU memory allocated at `43101 / 81920` MiB. The
