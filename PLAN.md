...
Latest heartbeat at `2026-05-16T22:40:22Z` showed coherent progress at
`completed_step=8880`, active step `8881`, phase `microbatch_done`, active
microbatch `1 / 8`, effective batch size `8`, `num_workers=0`, finite last
train loss `4.564347505569458`, live trainer PID `13262`, GPU utilization
sampled at `42%` with GPU memory allocated at `43101 / 81920` MiB. The
