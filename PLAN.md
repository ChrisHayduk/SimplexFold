...
Latest heartbeat at `2026-05-16T19:57Z` showed coherent progress at
`completed_step=8823`, active step `8824`, active microbatch `1 / 8`,
effective batch size `8`, `num_workers=4`, finite last train loss
`4.689121246337891`, live trainer PID `6336`, and GPU utilization sampled at
`41%` with `23191 / 81920` MiB allocated. The artifact directory still has no
