...
latest live check at `2026-05-18T05:39Z` reached `completed_step=9000`,
entered `phase=evaluating`, and reached active eval batch `5 / 1000`. The
...
`331052` alive with `194` threads. The artifact directory still had only
