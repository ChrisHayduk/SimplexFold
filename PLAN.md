...
Latest heartbeat at `2026-05-16T22:30:44Z` showed coherent progress at
`completed_step=8838`, active step `8839`, phase `microbatch_done`, active
microbatch `1 / 8`, effective batch size `8`, `num_workers=0`, finite last
train loss `4.1288584768772125`, live trainer PID `13262`, GPU utilization
sampled at `61%` with GPU memory allocated at `43101 / 81920` MiB. The
