...
def _run_status_payload(
    *,
    ...
    payload: dict[str, Any] = {
        ...
        "elapsed_seconds_run": float(elapsed_seconds_run),
...
def _apply_model_config_overrides(config: Any, args: argparse.Namespace) -> Any:
    ...
    for field, value in (
        ...
        ("simplex_boundary_oriented_cochain_scale", args.simplex_boundary_oriented_cochain_scale),
        ("simplex_boundary_face_cyclic_readout_scale", args.simplex_boundary_face_cyclic_readout_scale),
        (
            "simplex_boundary_signed_face_cyclic_readout_scale",
            args.simplex_boundary_signed_face_cyclic_readout_scale,
        ),
    ...
    *,
    ...
    for step in range(start_step, training_config.epochs + 1):
        ...
        if should_log:
            row: dict[str, float | int | str] = {
                ...
                "simplex_face_centroid_spread_weight": float(
                    loss_fn.simplex_geometry_loss.face_centroid_spread_weight
                ),
                ...
                "simplex_tetra_centroid_spread_weight": float(
                    loss_fn.simplex_geometry_loss.tetra_centroid_spread_weight
                ),
                ...
                "simplex_boundary_hodge_readout_runtime_scale": (
                    float("nan")
                    if simplex_boundary_hodge_readout_runtime_scale is None
                    else simplex_boundary_hodge_readout_runtime_scale
                ),
                "simplex_boundary_edge_star_readout_runtime_scale": (
                    float("nan")
                ...
                "simplex_boundary_oriented_cochain_runtime_scale": (
                    float("nan")
                    if simplex_boundary_oriented_cochain_runtime_scale is None
                    else simplex_boundary_oriented_cochain_runtime_scale
                ),
                "simplex_boundary_face_cyclic_readout_runtime_scale": (
                    float("nan")
                    if simplex_boundary_face_cyclic_readout_runtime_scale is None
                    else simplex_boundary_face_cyclic_readout_runtime_scale
                ),
                "simplex_boundary_signed_face_cyclic_readout_runtime_scale": (
                    float("nan")
                    if simplex_boundary_signed_face_cyclic_readout_runtime_scale is None
                    else simplex_boundary_signed_face_cyclic_readout_runtime_scale
                ),
    ...
    result: dict[str, Any] = {
        ...
        "simplex_boundary_hodge_readout_runtime_scale_ramp_start_step": (
            training_config.simplex_boundary_hodge_readout_runtime_scale_ramp_start_step
        ),
        "simplex_boundary_hodge_readout_runtime_scale_ramp_steps": (
            training_config.simplex_boundary_hodge_readout_runtime_scale_ramp_steps
        ),
        "simplex_boundary_edge_star_readout_runtime_scale": (
        ...
        "simplex_boundary_edge_star_readout_runtime_scale_ramp_start_step": (
            training_config.simplex_boundary_edge_star_readout_runtime_scale_ramp_start_step
        ),
        ...
        "simplex_boundary_oriented_cochain_runtime_scale_ramp_start_step": (
            training_config.simplex_boundary_oriented_cochain_runtime_scale_ramp_start_step
        ),
        "simplex_boundary_oriented_cochain_runtime_scale_ramp_steps": (
            training_config.simplex_boundary_oriented_cochain_runtime_scale_ramp_steps
        ),
        "simplex_boundary_face_cyclic_readout_runtime_scale": (
        ...
        "simplex_boundary_face_cyclic_readout_runtime_scale_ramp_start_step": (
            training_config.simplex_boundary_face_cyclic_readout_runtime_scale_ramp_start_step
        ),
        "simplex_boundary_face_cyclic_readout_runtime_scale_ramp_steps": (
            training_config.simplex_boundary_face_cyclic_readout_runtime_scale_ramp_steps
        ),
        "simplex_boundary_signed_face_cyclic_readout_runtime_scale": (
        ...
        "simplex_boundary_signed_face_cyclic_readout_runtime_scale_ramp_start_step": (
            training_config.simplex_boundary_signed_face_cyclic_readout_runtime_scale_ramp_start_step
        ),
        "simplex_boundary_signed_face_cyclic_readout_runtime_scale_ramp_steps": (
            training_config.simplex_boundary_signed_face_cyclic_readout_runtime_scale_ramp_steps
        ),
        ...
        "simplex_signed_tetra_coboundary_runtime_scale_ramp_start_step": (
            training_config.simplex_signed_tetra_coboundary_runtime_scale_ramp_start_step
        ),
        ...
        "simplex_signed_tetra_coboundary_scale": (
            float(getattr(model_config, "simplex_signed_tetra_coboundary_scale", 0.0))
            if use_simplicial
            else 0.0
        ),
        ...
        "simplex_boundary_oriented_cochain_scale": (
            float(getattr(model_config, "simplex_boundary_oriented_cochain_scale", 0.0))
            if use_simplicial
            else 0.0
        ),
        "simplex_boundary_face_cyclic_readout_scale": (
            float(getattr(model_config, "simplex_boundary_face_cyclic_readout_scale", 0.0))
            if use_simplicial
            else 0.0
        ),
        "simplex_boundary_signed_face_cyclic_readout_scale": (
            float(getattr(model_config, "simplex_boundary_signed_face_cyclic_readout_scale", 0.0))
            if use_simplicial
            else 0.0
        ),
...
def _write_csv(path: Path, rows: list[dict[str, Any]]) -> None:
    preferred = [
        ...
        "val_simplex_face_centroid_spread_loss",
        ...
        "val_simplex_tetra_centroid_spread_loss",
